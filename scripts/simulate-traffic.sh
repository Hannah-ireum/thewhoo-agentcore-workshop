...
# 의도된 schema 위반 invoke 5건을 섞어 UserErrors metric / 빨간 ! 마크 발생.
#
# 결과적으로 dashboard 모든 위젯에 데이터가 쌓입니다:
#   - Sessions: 10
...
# ─────────────────────────────────────────────────────────────────────
# 의도된 에러 페이로드 — Runtime layer schema validation 실패 유도
# ─────────────────────────────────────────────────────────────────────
ERROR_PAYLOADS=(
  '{"foo":"missing-message"}'
  'this-is-not-json'
...
# 의도된 에러 — UserErrors metric / 빨간 ! 마크 발생
...
echo "  2) Dashboard URL 새로고침 — 위젯 1·2·3·4·5·7 채워짐"
